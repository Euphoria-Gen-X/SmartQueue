...
➡️ Customers can view and book available slots
➡️ Receive confirmations via Email or SMS
➡️ Admin can manage the calendar, assign tokens and monitor real-time queue status
